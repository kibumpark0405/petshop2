<template>
    <div style="max-height:80vh;">
        ...
        >
            ...
            <wj-flex-grid-column binding="allegies" header="Allegies" width="2*" :isReadOnly="true" align="center">
                <wj-flex-grid-cell-template cellType="Cell" v-slot="cell">   
                    <List&lt;Allegy&gt; v-model="cell.item.allegies" :editMode="editMode"></List&lt;Allegy&gt;>
